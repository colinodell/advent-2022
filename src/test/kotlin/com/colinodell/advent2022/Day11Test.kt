...
class Day11Test {
    ...
    private val puzzleInput = listOf(
        Monkey(mutableListOf(71, 86), { it * 13 }, 19, 6, 7),
        Monkey(mutableListOf(66, 50, 90, 53, 88, 85), { it + 3 }, 2, 5, 4),
        Monkey(mutableListOf(97, 54, 89, 62, 84, 80, 63), { it + 6 }, 13, 4, 1),
        Monkey(mutableListOf(82, 97, 56, 92), { it + 2 }, 5, 6, 0),
        Monkey(mutableListOf(50, 99, 67, 61, 86), { it * it }, 7, 5, 3),
        Monkey(mutableListOf(61, 66, 72, 55, 64, 53, 72, 63), { it + 4 }, 11, 3, 0),
        Monkey(mutableListOf(59, 79, 63), { it * 7 }, 17, 2, 7),
        Monkey(mutableListOf(55), { it + 7 }, 3, 2, 1),
    )
